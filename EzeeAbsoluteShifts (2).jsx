    ...
    <>
      ...
      <DrawerPanel open={panelOpen} onClose={() => setPanelOpen(false)} title="Close Cash Drawer" width={500} extraFooter={stepFooter}>
        ...
        {step===0 && (<>
          ...
          {(() => {
            const drawerCcys = closeAccounting.currencies;
          ...
          {(() => {
            ...
            return (
              <>
                ...
                {drawerCcys.map(code => {
                  const drawerBal = closeAccounting.countedByCode[code] ?? sysByCode[code] ?? 0;
        ...
        {step===2 && (<>
          ...
          {(() => {
            ...
            return drawerCcys.map((cs, ci) => {
              ...
              const cashDrop = cs.cashDrop || 0;
              const endingBal = cs.endingBal;
              const rows2 = [
                { label:"Starting Balance",              count:"",       amount:`${code} ${cs.openingBal.toFixed(2)}`, bold:true  },
